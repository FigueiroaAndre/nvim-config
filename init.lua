...
-- vim.opt.shell = 'C:\\Program Files\\Git\\bin\\bash.exe' -- Not Working
...
vim.keymap.set('n', '<c-left>', '<cmd>vertical resize -1<CR>', { desc = 'Reduce window width' })
vim.keymap.set('n', '<c-right>', '<cmd>vertical resize +1<CR>', { desc = 'Grow window width' })
vim.keymap.set('n', '<c-up>', '<cmd>horizontal resize +1<CR>', { desc = 'Grow window height' })
vim.keymap.set('n', '<c-down>', '<cmd>horizontal resize -1<CR>', { desc = 'Reduce window height' })
...
vim.keymap.set('n', '<leader>bb', '<cmd>Oil .<CR>', { desc = 'Open Oil in root folder' })
vim.keymap.set('n', '<leader>bf', '<cmd>Oil<CR>', { desc = 'Open Oil in current file' })
